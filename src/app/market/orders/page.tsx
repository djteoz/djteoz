...
export default async function OrdersPage() {
  ...
  try {
    ...
    // Return empty orders array to avoid crashing the page
    orders = [];
  }
                    ...
                    <div className="flex justify-between items-start">
                      <div>
                        ...
                        <Link
                          ...
                          className="font-medium text-gray-900 dark:text-white hover:text-indigo-600 transition-colors line-clamp-1"
                        >
                          {item.product.title}
                        </Link>
                      </div>
